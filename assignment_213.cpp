...
void *threadFunc(void *pArg) 
{
    ...
    new_time.it_interval.tv_nsec = 1000000;    // 1 ms that the timer "sleeps" interval-wise
    new_time.it_value.tv_sec = 0;
    new_time.it_value.tv_nsec = 1000000;       // 1 ms that the timer "sleeps" interval-wise
