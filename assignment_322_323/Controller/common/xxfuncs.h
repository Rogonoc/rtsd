...
/* XXDelay is model specific and therefore implemented in Controller.cpp */
/* XXInitialValue is model specific and therefore implemented in Controller.cpp */
...
/* XXStopSimulation is implemented in Controller.cpp */
